...
fn test_dependency_local_path() -> anyhow::Result<()> {
    let near_sdk_dir = clone_git_repo("c0ddc89b8ab30450c2e493c6d64187c63009e026")?;
...
fn test_dependency_patch() -> anyhow::Result<()> {
    ...
    //
    // [patch.crates-io]
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "c0ddc89b8ab30450c2e493c6d64187c63009e026" }
    let abi_root = generate_abi_fn! {
