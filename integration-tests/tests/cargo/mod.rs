...
fn test_dependency_local_path() -> anyhow::Result<()> {
    let near_sdk_dir = clone_git_repo("bc7b0e7db36c3065d9265d3c12918ec3758bfd76")?;
...
fn test_dependency_patch() -> anyhow::Result<()> {
    ...
    //
    // [patch.crates-io]
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "bc7b0e7db36c3065d9265d3c12918ec3758bfd76" }
    let abi_root = generate_abi_fn! {
