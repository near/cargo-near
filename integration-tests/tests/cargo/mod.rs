...
fn test_dependency_local_path() -> anyhow::Result<()> {
    let near_sdk_dir = clone_git_repo("97a0d01cafe1cd7dceb2774f5840052e577edf40")?;
...
fn test_dependency_patch() -> anyhow::Result<()> {
    ...
    //
    // [patch.crates-io]
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "97a0d01cafe1cd7dceb2774f5840052e577edf40" }
    let abi_root = generate_abi_fn! {
