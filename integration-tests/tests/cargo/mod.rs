...
fn test_dependency_local_path() -> anyhow::Result<()> {
    let near_sdk_dir = clone_git_repo("ff45f49380fae282ec19f413af60080c692196f1")?;
...
fn test_dependency_patch() -> anyhow::Result<()> {
    ...
    //
    // [patch.crates-io]
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "ff45f49380fae282ec19f413af60080c692196f1" }
    let abi_root = generate_abi_fn! {
