...
fn test_dependency_local_path() -> anyhow::Result<()> {
    let near_sdk_dir = clone_git_repo("11f60860fd6c34e9d27f37bb1ff9930c2aaa42e3")?;
...
fn test_dependency_local_path_with_version() -> anyhow::Result<()> {
    ...
    // near-sdk = { path = "::path::", version = "4.0.0", features = ["abi"] }
    let abi_root = generate_abi_fn! {
...
fn test_dependency_explicit() -> anyhow::Result<()> {
    ...
    // rev = "11f60860fd6c34e9d27f37bb1ff9930c2aaa42e3"
    // features = ["abi"]
    let abi_root = generate_abi_fn! {
...
fn test_dependency_no_default_features() -> anyhow::Result<()> {
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "11f60860fd6c34e9d27f37bb1ff9930c2aaa42e3", default-features = false, features = ["abi"] }
    let abi_root = generate_abi_fn! {
...
fn test_dependency_renamed() -> anyhow::Result<()> {
    // near = { git = "https://github.com/near/near-sdk-rs.git", rev = "11f60860fd6c34e9d27f37bb1ff9930c2aaa42e3", package = "near-sdk", features = ["abi"] }
...
fn test_dependency_patch() -> anyhow::Result<()> {
    ...
    //
    // [patch.crates-io]
    // near-sdk = { git = "https://github.com/near/near-sdk-rs.git", rev = "11f60860fd6c34e9d27f37bb1ff9930c2aaa42e3" }
    let abi_root = generate_abi_fn! {
