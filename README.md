...
with a scaffold project, generated by `cargo near new` command.

Associated Github Codespaces `devcontainer` usually contains most up-to-date versions of [near-cli-rs](https://github.com/near/near-cli-rs) and `cargo-near` (this repo) CLIs,
which can be tested/played around with without installing anything. 
