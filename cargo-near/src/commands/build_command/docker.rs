use cargo_near_build::docker_build_types::{cloned_repo, crate_in_repo, metadata};
use cargo_near_build::{
    camino, docker_checks, git_checks, subprocess_step, BuildContext, DockerBuildOpts,
    ERR_REPRODUCIBLE,
};
